...
exports.Mail = function(userEmail, codeEmail) {
    let data = {
        ...
        title: '欢迎注册',
        html:
            '<div></div><h1 style="color: #153643;font-family: Arial, sans-serif;font-size: 24px;">欢迎注册</h1><p style="padding: 20px 0 30px 0;color: #153643;font-family: Arial, sans-serif;font-size: 16px;line-height: 20px;">欢迎注册Egg社区，你的验证码是：<span style="color:red">' +
            codeEmail +
            '</span></p></div>',
    };
    // 开启一个 SMTP 连接池
