module.exports = app => {
    const { STRING, TEXT, INTEGER, DATE, BOOLEAN, NOW } = app.Sequelize;
    const schema = {
        id: {
            type: INTEGER,
            primaryKey: true,
    ...
    const Topic = app.model.define('pangu_topic', schema, {
