...
import { fetchTopicList } from '@pangu/client/web/api/topic';
...
const headCells = [
    ...
    { id: 'author', numeric: false, disablePadding: false, label: '作者' },
    { id: 'createdAt', numeric: false, disablePadding: false, label: '创建时间' },
    { id: 'top', numeric: false, disablePadding: false, label: '是否置顶' },
    { id: 'tag', numeric: false, disablePadding: false, label: '分类' },
    { id: 'ctrl', numeric: false, disablePadding: false, label: '操作' },
];
...
export default function EnhancedTable() {
    ...
    return (
        <Paper style={{ padding: '40px 40px 40px 200px' }}>
                ...
                <Table className={classes.table} aria-labelledby="tableTitle" size={dense ? 'small' : 'medium'}>
                    ...
                    <TableBody>
                        {topics.rows.map(item => (
                            <TableRow onClick={event => handleClick(event, item.name)} role="checkbox" key={item.id}>
                                <TableCell padding="checkbox">
                                ...
                                <TableCell>
                                    <span className="put_top">{item.top ? '是' : '否'}</span>
                                </TableCell>
                                <TableCell>
                                    <span className="put_top">{TOPIC_TYPE[item.type]}</span>
                                </TableCell>
                                <TableCell>
                                    <Link href={`/write?topicId=${item.id}`}>
