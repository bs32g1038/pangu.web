...
import { AppBar, Toolbar, IconButton, InputBase, Menu, MenuItem, Fab, withStyles } from '@material-ui/core';
import {
    Menu as MenuIcon,
...
const Header = ({ classes, isSidebarOpened, toggleSidebar, ...props }) => (
    <AppBar position="fixed" className={classes.appBar}>
        <Toolbar className={classes.toolbar}>
            ...
            >
                <Badge badgeContent={props.isNotificationsUnread ? notifications.length : null} colortheme="warning">
            ...
            <IconButton
                ...
                className={classes.headerMenuButton}
            >
                <Badge badgeContent={props.isMailsUnread ? messages.length : null} color="secondary">
            ...
            >
                ...
                <div className={classes.profileMenuUser}>
                    <Typography className={classes.profileMenuLink} color="primary" onClick={props.signOut}>
                        Sign Out
                    </Typography>
                </div>
            </Menu>
